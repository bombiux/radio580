...
function toggleDashiconClass() {
  ...
  if ( butoon.contains('dashicons-controls-play') ) {
    
    butoon.remove('dashicons-controls-play');
    
    butoon.add('dashicons-controls-pause');

  } else {
    butoon.remove('dashicons-controls-pause');
    
    butoon.add('dashicons-controls-play');
  }
