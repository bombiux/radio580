...
function toggleDashiconClass() {
  let button = document.getElementById(playerButton).classList;

  if ( playerButton.classList.contains('dashicons-controls-play') ) {
    
    playerButton.classList.remove('dashicons-controls-play');
    
    playerButton.classList.add('dashicons-controls-pause');

  } else {
    playerButton.classList.remove('dashicons-controls-pause');
    
    playerButton.classList.add('dashicons-controls-play');
  }
