...
function toggleDashiconClass() {
  ...
  if ( but.contains('dashicons-controls-play') ) {
    
    but.remove('dashicons-controls-play');
    
    but.add('dashicons-controls-pause');

  } else {
    but.remove('dashicons-controls-pause');
    
    but.add('dashicons-controls-play');
  }
